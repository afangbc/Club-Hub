...
export async function buildSeedDatabase(): Promise<Database> {
  ...
  return {
    ...
    clubs: [
      ...
      { id: "c-robotics", schoolId: FRISCO_SCHOOL_ID, name: "Robotics Team 4412", category: "STEM", visibility: "private", sponsorId: "u-alvarez", room: "Shop B", schedule: { frequency: "biweekly", weekday: 3, week: 1, hour: 16, minute: 0 }, blurb: "Build season, tools, CAD, programming, and drive team.", joinInstructions: "Attend an open build night and complete the shop safety quiz.", createdAt },
      { id: "c-nhs", schoolId: FRISCO_SCHOOL_ID, name: "National Honor Society", category: "Service", visibility: "private", sponsorId: "u-whitfield", room: "Library", schedule: { frequency: "monthly", weekday: 4, week: 1, hour: 7, minute: 30 }, blurb: "Scholarship, service, leadership, and character.", joinInstructions: "Submit the interest form and service-hour record to the sponsor.", createdAt },
      { id: "c-key", schoolId: FRISCO_SCHOOL_ID, name: "Key Club", category: "Service", visibility: "public", sponsorId: "u-whitfield", room: "B-220", schedule: { frequency: "weekly", weekday: 4, week: 1, hour: 16, minute: 0 }, blurb: "Volunteer projects across Frisco ISD with service hours tracked together.", createdAt },
    ],
    memberships: [
      ["m-1", "c-tsa", "u-rivera", "member", ""], ["m-2", "c-tsa", "u-park", "member", ""],
      ["m-3", "c-key", "u-rivera", "member", ""], ["m-4", "c-key", "u-fitzgerald", "member", ""],
